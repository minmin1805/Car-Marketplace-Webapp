...
const CalculateMonthlyPayment=() => {
  ...
  return (
    ...
    <h2 className='font-medium text-2xl'>Financial Caculator</h2>
        ...
        {monthlyPayment>0&& <h2 className='font-medium text-2xl mt-6'>Your Monthly Payment Is: <span className='text-4xl font-bold'>${monthlyPayment}</span> </h2>}
